...
<Warning>
Each run costs 3 credits (plus any tool calls), and the agent can use every tool it has access to — including changing or deleting things in your connected accounts. Write the task carefully and use at your own risk.
</Warning>

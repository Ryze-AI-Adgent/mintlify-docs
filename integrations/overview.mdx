...
Each platform connects one account per workspace. To work with a second account — say, a second Google Ads account on a different login — create a separate [workspace](/workspaces/create-workspace).

...
The link works once and expires after 24 hours (a sign-in started just before that gets 15 more minutes to finish). It never signs anyone in to Ryze: whoever opens it can only connect a platform to that workspace.

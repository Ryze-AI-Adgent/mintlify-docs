...
- `ryze.identify` attaches an email or phone to the session. Identified events match better on every platform, so call it as soon as you know who the visitor is: after login, on checkout, after a form submit.
